...
function BenefitSection({ data }: BenefitSectionProps) {
  ...
  const title = currentLocale === "vi" ? data.title_vi : data.title_en;
  const desc = currentLocale === "vi" ? data.desc_vi : data.desc_en;
      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            ...
            >
              {currentLocale === "vi" ? "Xem công việc của tôi" : "See my work"}
        ...
        <div className="md:hidden">
          <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
            {data.bullets.map((item, index) => {
              const bulletTitle = currentLocale === "vi" ? item.title_vi : item.title_en;
              const bulletDesc = currentLocale === "vi" ? item.desc_vi : item.desc_en;
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{bulletTitle}</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">{bulletDesc}</p>
